...
Create database if not exists `csu_lost_found` default character set utf8mb4 collate utf8mb4_general_ci;
USE `csu_lost_found`;
...
ALTER TABLE `items`
  ...
  ADD KEY `idx_created_at` (`created_at`);
-- Additional composite index to filter lists efficiently
ALTER TABLE `items`
  ADD KEY `idx_status_created` (`status`, `created_at`),
  ADD KEY `idx_reported_status` (`reported_by`, `status`);
...
ALTER TABLE `messages`
  ...
  ADD KEY `idx_created_at` (`created_at`),
  ADD KEY `idx_receiver_read_created` (`receiver_id`, `is_read`, `created_at`),
  ADD KEY `idx_sender_created` (`sender_id`, `created_at`),
  ADD KEY `idx_item_created` (`item_id`, `created_at`);
-- Additional composite index for inbox performance
ALTER TABLE `messages`
  ADD KEY `idx_receiver_read_created` (`receiver_id`, `is_read`, `created_at`);
...
ALTER TABLE `notifications`
  ...
  ADD KEY `idx_created_at` (`created_at`);
-- Additional composite index to speed unread queries per user
ALTER TABLE `notifications`
